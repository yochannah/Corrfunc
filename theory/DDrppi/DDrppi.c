...
--- DDrppi file1 format1 file2 format2 binfile pimax numthreads [weight_method weights_file1
...
int main(int argc, char *argv[])
{
  ...
  for (int i = 1; i < results.nbin; i++) {
    ...
    for (int j = 0; j < npibin; j++) {
      ...
      fprintf(stdout, "%e\t%e\t%e\t%12" PRIu64 "\t%e\n", logrp, (j + 1) * dpi, results.rpavg[index],
  ...
  fprintf(stderr,
          "DDrppi> Done -  ND1=%12" PRId64 " ND2=%12" PRId64 ". Time taken = %6.2lf seconds. "
...
void Printhelp(void)
{
  fprintf(stderr, "=========================================================================\n");
#if defined(USE_OMP) && defined(_OPENMP)
  fprintf(stderr, "   --- DDrppi file1 format1 file2 format2 binfile pimax numthreads "
                  "[weight_method weights_file1 weights_format1 [weights_file2 weights_format2]] > "
                  "DDfile\n");
#else
  fprintf(stderr, "   --- DDrppi file1 format1 file2 format2 binfile pimax [weight_method "

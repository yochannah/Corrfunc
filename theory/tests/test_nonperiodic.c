    ...
    for (int j = 0; j < npibin; j++) {
      ...
      if (npairs == results.npairs[index] && floats_equal == EXIT_SUCCESS &&
        ...
        fprintf(stderr, "Failed. True rpavg = %e Computed rpavg = %e. floats_equal = %d\n", rpavg,
                results.rpavg[index], floats_equal);
...
int main(int argc, char **argv)
{
  ...
  const char alltests_names[][MAXLEN] = {"Mr19 DD (nonperiodic)", "Mr19 DDrppi (nonperiodic)",
  ...
  const char correct_outputfiles[][MAXLEN] = {"Mr19_DD_nonperiodic", "Mr19_DDrppi_nonperiodic",
                                              "Mr19_DDsmu_nonperiodic", "cmass_DR_nonperiodic"};
  const char firstfilename[][MAXLEN] = {"../tests/data/gals_Mr19.ff", "../tests/data/gals_Mr19.ff",
                                        "../tests/data/gals_Mr19.ff",
                                        "../tests/data/cmassmock_Zspace.ff"};
  const char firstfiletype[][MAXLEN] = {"f", "f", "f", "f"};
  const char secondfilename[][MAXLEN] = {"../tests/data/gals_Mr19.ff", "../tests/data/gals_Mr19.ff",
                                         "../tests/data/gals_Mr19.ff",

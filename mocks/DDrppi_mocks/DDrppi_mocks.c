...
--- DDrppi file1 format1 file2 format2 binfile pimax cosmology numthreads [weight_method
...
int main(int argc, char *argv[])
{
  ...
  const char argnames[][30] = {"file1",   "format1", "file2",          "format2",
                               "binfile", "pimax",   "cosmology flag", "numthreads"};
#else
  const char argnames[][30] = {"file1",   "format1", "file2",         "format2",
                               "binfile", "pimax",   "cosmology flag"};
#endif
  ...
  fprintf(stderr,
          "DDrppi> Done -  ND1=%" PRId64 " ND2=%" PRId64
...
void Printhelp(void)
{
  fprintf(stderr, "=========================================================================\n");
#if defined(_OPENMP)
  fprintf(stderr, "   --- DDrppi file1 format1 file2 format2 binfile pimax cosmology numthreads "
                  "[weight_method weights_file1 weights_format1 [weights_file2 weights_format2]] > "
                  "DDfile\n");
#else
  fprintf(stderr, "   --- DDrppi file1 format1 file2 format2 binfile pimax cosmology "
                  "[weight_method weights_file1 weights_format1 [weights_file2 weights_format2]] > "
                  "DDfile\n");
#endif

...
#define AVX2_BLEND_FLOATS_WITH_MASK(FALSEVALUE, TRUEVALUE, MASK)                                   \
  _mm256_blendv_ps(FALSEVALUE, TRUEVALUE, MASK)
#define AVX2_BLEND_INTS_WITH_MASK(FALSEVALUE, TRUEVALUE, MASK)                                     \
  _mm256_blend_epi32(FALSEVALUE, TRUEVALUE, MASK)
...
#define AVX2_BLEND_FLOATS_WITH_MASK(FALSEVALUE, TRUEVALUE, MASK)                                   \
  _mm256_blendv_pd(FALSEVALUE, TRUEVALUE, MASK)
#define AVX2_BLEND_INTS_WITH_MASK(FALSEVALUE, TRUEVALUE, MASK)                                     \
  _mm_blend_epi32(FALSEVALUE, TRUEVALUE, MASK)
...
#else
#define AVX2_ARC_COSINE(X, order) inv_cosine_avx(X, order)    // avx and avx2 are the same wrt
                                                              // floats
#endif
